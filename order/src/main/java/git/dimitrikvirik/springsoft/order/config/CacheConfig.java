...
import git.dimitrikvirik.springsoft.order.model.OrderDataSerializableFactory;
...
public class CacheConfig {
    ...
    public ClientConfig hazelcastClientConfig() {
        ...
        serializationConfig.addDataSerializableFactory(OrderDataSerializableFactory.FACTORY_ID, new OrderDataSerializableFactory());
